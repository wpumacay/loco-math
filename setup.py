...
class BuildCommand(BaseBuildExtCommand):
    ...
    def build_extension(self, extension):
        ...
        _cmakeArgs = [
            "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=" + _extensionDirPath,
        ...
        _env["CXXFLAGS"] = '{} -DVERSION_INFO=\\"{}\\"'.format(
            _env.get("CXXFLAGS", ""), self.distribution.get_version()
        )
...
setup(
    ...
    package_data={},
    ext_modules=[CMakeExtension("tinymath", ".")],
